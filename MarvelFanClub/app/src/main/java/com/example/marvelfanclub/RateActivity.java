...
public class RateActivity extends YouTubeBaseActivity {

        private static final String YOUTUBE_API_KEY = "AIzaSyB0kNs9hxxXw62ij8jOJYpt0kmjlyKL1Tc";
        ...
        com.codepath.marvelfanapp.Movie movie;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            tvTitle = findViewById(R.id.tvDetails);
            tvOverview = findViewById(R.id.tvOverview);
            ratingBar = findViewById(R.id.ratingBar);
            youTubePlayerView = findViewById(R.id.player);

            movie = (com.codepath.marvelfanapp.Movie) Parcels.unwrap(getIntent().getParcelableExtra("movie"));
